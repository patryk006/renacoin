...
uint256 hashGenesisBlock("0x36382cea829e2017062bb7a73692127c761b4bf3e67ed275143725c53e0ba696");
...
const string strMessageMagic = "RenaCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // RenaCoin: 1 days
static const int64 nTargetSpacing = 120; // RenaCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal renacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RenaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x015572b2f46a2697a173d86c3db71fdbb714ce52a8f6791b63139bf0be188e4a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1373039072; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2243600;

        if (fTestNet)
        {
            block.nTime    = 1372981417;
            block.nNonce   = 1744550;
        }
